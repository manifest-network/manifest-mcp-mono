...
|-------|----------|---------------|
| [Tool selection guide](tool-selection-guide.md) | Users + agents | Which of the five MCP servers to wire up, and which tool to reach for in common scenarios |
...
| [SDK cookbook](library-usage.md) | Developers | The library deep dive: wallets, the three client factories, reads/txs, deploy lifecycle, live status, errors (Barney is the reference consumer) |
