...
- **`SkuIntent`** = `{ kind:'byName'; size: TierName; providerUuid?: ProviderUuid; skuUuid?: SkuUuid } | { kind:'resolved'; skuUuid: SkuUuid; providerUuid: ProviderUuid }` (unifies fred's `SkuSelector`).
