 ...
 *
 * Kept local to this package; `packages/core` stays untouched until a
 * second consumer needs the helper.
 */
 ...
 * the helper's purpose (e.g. `MANIFEST_AGENT_FETCH_GUARDED=ture` would
 * silently no-op the SSRF guard the operator clearly intended to keep
 * on).
 *
