      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              `- \`Internal\`, \`CleanupFailed\` and \`VolumeCleanupExhausted\` are provider-side: the user cannot fix them. Say so and point to operator escalation rather than suggesting retries.`,
              ``,
              `Then summarize:`,
